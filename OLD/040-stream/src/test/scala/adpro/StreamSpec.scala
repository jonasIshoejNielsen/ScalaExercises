...
class StreamSpec 
  ...
  "Exercise 12" - {
    "fib2.take(10).toList should give correct result" in {
      fib2.take(10).toList shouldBe fibs.take (10).toList
    }
    "from2(100).take(10).toList should give correct result" in {
      from2(100).take(10).toList shouldBe from(100).take(10).toList
    }
  }
  "Exercise 11" - {
  ...
  "Exercise 6" - {
    ...
    "naturals.takeWhile2 {_ < 1000000000 }.drop (100).take (50).toList should not crash" in {
      naturals.takeWhile2 { _ < 1000000000 }.drop (100).take (50).toList.size should be (50)
    }
  }
